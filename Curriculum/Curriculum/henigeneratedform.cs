...
{
    public partial class henigeneratedform : Form
    {
        public henigeneratedform(
        ...
        private void btn_Click(object sender, EventArgs e)
        {
            ...
            henifillupform fillupForm = new henifillupform();
            fillupForm.Show();
        ...
        {
            henifillupform form1 = new henifillupform();
            form1.Show();
            this.Hide();
        }
    }
